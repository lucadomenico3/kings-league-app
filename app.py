...
# Stile CSS per Sfondo e Trasparenze
def aggiungi_stile():
    st.markdown(
        """
        <style>
...
if st.sidebar.button("🔄 Aggiorna Dati"): st.rerun()
...
if menu == "📊 Classifica":
    ...
    if df_cal is not None: st.dataframe(df_cal, use_container_width=True, hide_index=True)
